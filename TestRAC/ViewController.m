...
//    [testBtn setTitle:@"测试用" forState:UIControlStateNormal];
//    [self.view addSubview:testBtn];
    
    ViewA *a = [[ViewA alloc] initWithFrame:CGRectMake(30, 20, 200, 80)];
    a.backgroundColor = [UIColor grayColor];
    [self.view addSubview:a];
    
    ViewB *b = [[ViewB alloc] initWithFrame:CGRectMake(30, 130, 200, 80)];
...
- (void)testBtn {
    ...
    vc.siganl = [RACSubject subject];
    [vc.siganl subscribeNext:^(id x) {
        ;
    }];
